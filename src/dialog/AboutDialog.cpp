...
wxBEGIN_EVENT_TABLE(AboutDialog, wxDialog)
    EVT_HTML_LINK_CLICKED(wxID_ANY, AboutDialog::handleLink)
wxEND_EVENT_TABLE()
...
bool AboutDialog::createWindow(wxWindow* parent
...
void AboutDialog::createControls(int tabToOpenNo)
{
...
void AboutDialog::handleLink(wxHtmlLinkEvent& event)
{
