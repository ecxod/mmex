...
inline bool PrefModel::getDatabaseUpdated() const noexcept
{
    return m_database_updated;
}

inline const wxString& PrefModel::getLocaleName() const
{
    return m_locale_name;
}

inline const wxString PrefModel::getDateFormat() const
{
    return m_date_format;
}

inline const wxString& PrefModel::getUserName() const
{
    return m_user_name;
}

inline int64 PrefModel::getBaseCurrencyID() const noexcept
{
...
inline int PrefModel::getReportingFirstDay() const noexcept
{
    return m_reporting_first_day;
}

inline wxDateTime::WeekDay PrefModel::getReportingFirstWeekday() const noexcept
{
    return m_reporting_first_weekday;
}

inline int PrefModel::getFinancialFirstDay() const
{
    return m_financial_first_day;
}

inline wxDateTime::Month PrefModel::getFinancialFirstMonth() const {
    return m_financial_first_month;
}

inline int PrefModel::getBudgetDaysOffset() const noexcept
{
    return m_budget_days_offset;
}

inline int PrefModel::getHomePageIncExpRange() const noexcept
{
    return m_homepage_incexp_range;
}

inline int PrefModel::getIconSize() const noexcept
{
    return m_icon_size;
}

inline int PrefModel::getNavigationIconSize() const noexcept
{
    return m_navigation_icon_size;
}

inline int PrefModel::getToolbarIconSize() const noexcept
{
    return m_toolbar_icon_size;
}

inline int PrefModel::getTransCategoryNone() const noexcept
{
    return m_trans_category_none;
}

inline int PrefModel::getTransCategoryTransferNone() const noexcept
{
    return m_trans_category_transfer_none;
}

inline int PrefModel::getTransPayeeNone() const noexcept
{
...
inline bool PrefModel::getCheckNews() const noexcept
{
    return m_check_news;
}

inline bool PrefModel::getHideShareAccounts() const noexcept
{
    return m_hide_share_accounts;
}

inline bool PrefModel::getHideDeletedTransactions() const noexcept
{
    return m_hide_deleted_transactions;
}

inline bool PrefModel::getBudgetFinancialYears() const noexcept
{
    return m_budget_financial_years;
}

inline bool PrefModel::getBudgetIncludeTransfers() const noexcept
{
    return m_budget_include_transfers;
}

inline bool PrefModel::getBudgetSummaryWithoutCategories() const noexcept
{
...
inline bool PrefModel::getBudgetOverride() const noexcept
{
    return m_budget_override;
}

inline bool PrefModel::getBudgetDeductMonthly() const noexcept
{
    return m_budget_deduct_monthly;
}

inline int PrefModel::getThemeMode() const noexcept
{
    return m_theme_mode;
}
...
inline bool PrefModel::getShowToolTips() const noexcept
{
    return m_show_tooltips;
}

inline bool PrefModel::getShowMoneyTips() const noexcept
{
    return m_show_moneytips;
}

inline const wxArrayString PrefModel::getCheckingRange() const noexcept
{
    return m_checking_range;
}

inline const std::vector<mmDateRange2::Range> PrefModel::getCheckingRangeA() const noexcept
{
    return m_checking_range_a;
}

inline int PrefModel::getCheckingRangeM() const noexcept
{
    return m_checking_range_m;
}

inline const wxArrayString PrefModel::getReportingRange() const noexcept
{
    return m_reporting_range;
}

inline const std::vector<mmDateRange2::Range> PrefModel::getReportingRangeA() const noexcept
{
    return m_reporting_range_a;
}

inline int PrefModel::getReportingRangeM() const noexcept
{
    return m_reporting_range_m;
}

inline bool PrefModel::getShowNavigatorCashLedger() const noexcept
{
